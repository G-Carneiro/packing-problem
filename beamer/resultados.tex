...
\begin{frame}
    ...
    \begin{table}
        ...
        \begin{tabular}{lllrrrrr}
            \hline
            R & O & Desc.\  & W  & D  & Quality \% & Time (s)   \\
            \hline
            V & W & T      & 9  & 8  & 84.5497    & 2.4820e-03 \\
            M & P & T      & 7  & 6  & 85.8682    & 1.2944e-02 \\
            N & A & T      & 13 & 11 & 87.2957    & 6.4349e+00 \\
            N & W & T      & 16 & 10 & 85.9266    & 8.4384e+00 \\
            \hline
        \end{tabular}
    \end{table}
...
\mode<handout>{
    ...
    \label{tab:instances}
    \small\ttfamily\input{utils/tabular/compare/instanceset}
    \end{table}
