...
\begin{frame}
    ...
    \begin{table}
        ...
        \begin{tabular}{lllrrrrr}
            ...
            \hline
            V & W & T      & 9  & 8  & 84.5497    & 47.0580  & 0.0024   \\
            M & P & T      & 7  & 6  & 85.8682    & 46.3078  & 0.0129   \\
            N & A & T      & 13 & 11 & 85.3558    & 42.9123  & 6.2918   \\
            N & W & T      & 16 & 10 & 84.0171    & 48.1854  & 8.2509   \\
            \hline
        \end{tabular}
    \end{table}
...
\begin{frame}
    ...
    \begin{table}
        \centering
        \ttfamily\caption{Resultados para os conjuntos de instância.}
        \label{tab:instances}
