...
\begin{frame}
    ...
    \note{
        ...
        Cada caso foi executado 5 vezes para se obter um média, totalizando 9000 execuções.
    }
\end{frame}
...
\begin{frame}
    ...
    \note{
        ...
        A literatura em geral usa somente ordenação pela área~\cite{chen2019efficient}, então esses
...
\begin{frame}
    ...
    teve acréscimo na qualidade. Aqui a gente percebe que precisar resolver a \Cref{eq:2}, faz com
...
\begin{frame}
    ...
    de verificações igual a $(n^3 - n)/3$, isso no pior caso, algo extremante custoso.
