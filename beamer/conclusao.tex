...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \note{\tiny Bom, indo para as conclusões. Foram testados vários métodos de solução,
        ...
        ordenação, sendo necessária uma investigação sobre as características das instâncias.
        E também a pouca, ou nenhuma, vantagem em termos de qualidade quando usamos regiões que
        permitem sobreposições.
        Outro ponto interessante, é que o tempo de execução do algoritmo não depende do tamanho dos
        itens ou do recipiente, somente do número total de itens.
