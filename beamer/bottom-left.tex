...
\begin{frame}
    ...
    \note{
        ...
        decrescente, 4 formas de criar regiões e cada uma dessas configurações foi executada 5
        vezes, temos o total de 9000 execuções.

        O tempo somado de todas as execuções levou em torno de 5 horas (valor que ainda
