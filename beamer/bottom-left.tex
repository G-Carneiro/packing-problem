...
\begin{frame}
    ...
    \only<2->{
        \begin{figure}[!htb]
            \centering
            \includegraphics<2>[scale=0.5]{output/figures/bkw/bkw01/vertically/area/false/01}
            \includegraphics<3>[scale=0.5]{output/figures/bkw/bkw01/horizontally/area/false/01}
            \includegraphics<4>[scale=0.5]{output/figures/bkw/bkw01/max_area/area/false/01}
            \includegraphics<5>[scale=0.5]{output/figures/bkw/bkw01/none/area/false/01}
            \caption{
    ...
    \note<1>{
        ...
        Utilizando essa técnica é possível ignorar a restrição \autoref{eq:eq2}.
        ...
        restrição \autoref{eq:eq1}, tornando o algoritmo de solução bem simples.
    ...
    cumprir a restrição \autoref{eq:eq2}. Teoricamente ao permitir sobreposições possibilita
