...
\begin{frame}
    ...
    \framesubtitle{Modelos de otimização}
    \[
...
\begin{frame}
    \frametitle{Conceitos básicos}
    \framesubtitle{Tipos de soluções}
    \begin{itemize}
        \item Factível.
        \begin{itemize}
            \item Ótima.
...
\begin{frame}
    \frametitle{Conceitos básicos}
    \framesubtitle{Métodos exatos × heurísticos}
    \begin{columns}
    ...
    \note{
        ...
        Heurísticas geralmente são simples e acabam caindo em ótimos locais.
    }
\end{frame}
