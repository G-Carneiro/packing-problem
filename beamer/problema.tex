...
\begin{frame}
    ...
    \note{
        ...
        É algo simples, mas de difícil resolução, podendo possuir $N$-dimensões e diversos tipos
        de peças, de modo que é preciso separar o problema em diferentes classes e ainda existem
        variantes dentro dessas classificações.
        Como exemplos:

        Temos o caso 1D que pode ser usado para cortar uma barra de ferro em certos tamanhos,
        de forma que seu desperdício seja mínimo.

        Já o 2D poderia ser aplicado para alocação de paletes com altura fixa em um caminhão
        ou depósito.

        O caso 3D pode ser usado para alocar caixas em um depósito ou container, e
...
\begin{frame}
    ...
    \note{
        ...
        Para resolver o problema ele será representado como um modelo de otimização, e portanto,
