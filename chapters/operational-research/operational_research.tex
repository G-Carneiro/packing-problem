...
\subsection{Modelo Linear $\times$ Não-linear}\label{subsec:modelo-linear}
...
\subsection{Modelo Contínuo $\times$ Discreto}\label{subsec:modelo-continuo-x-discreto}
...
\input{utils/figures/continuo-discreto}

\subsection{Modelo Determinístico $\times$ Estocástico}\label{subsec:modelo-deterministico-x-estocastico}
...
\section{Métodos Exatos $\times$ Heurísticos}\label{sec:metodos-exatos-heuristicos}
