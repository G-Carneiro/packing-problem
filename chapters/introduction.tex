...
(\Cref{ch:bottom-left}), alguns conceitos básicos são mostrados no \autoref{ch:conceitos-basicos}.
...
% FIXME: usar abordagem do tipo "funil" para contruir o texto.
% Começa ilustrando problemas reais que podem ser traduzidos para problemas de empacotamento
% 1D, 2D e 3D. Cita as complexidades de cada um, formas de tratar, citando técnicas e algoritmos.
% Enfatiza que vai tratar do 2D, justifica.
% Apresenta o problema, tomba para os objetivos
