...
definição formal.
De acordo com \citeauthoryear{2DPackLib}, dado uma caixa retangular $\mathcal{B} = (W, H)$ de
...
\input{utils/equations/restricoes}
...
A \Cref{eq:1} garante que cada item deve estar inteiramente na caixa, enquanto a \Cref{eq:2}
