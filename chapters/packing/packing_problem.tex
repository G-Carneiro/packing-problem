...
O trabalho de \citeauthoryear{wascher2007improved} fornece a classificação de problemas de corte e
empacotamento baseado na sua dimensão, tipos de itens, tipo de recipiente e função objetivo,
fornecendo uma atualização da tipologia definida em \citeauthoryear{dyckhoff1990typology}.
...
Inclusive, existem vários trabalhos como \citeauthoryear{wei2011skyline} e outros mais recentes~\cite{
...
em um polígono convexo (\Cref{fig:pieces-example}).
