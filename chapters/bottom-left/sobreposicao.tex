\section{Sobreposição e domínio contínuo}\label{sec:sobreposicao-e-dominio-infinito}
...
respeitar a \Cref{eq:2} (sobreposição de peças) e o domínio contínuo de coordenadas
...
A \Cref{fig:sobreposicao-dominio} mostra um estado intermediário do algoritmo de solução, onde o
item 0 foi alocado na coordenada (0, 0) e o item 1 foi alocado a sua direita na posição (2, 0)
para respeitar a \Cref{eq:1}, porque não cabe logo acima na posição (0, 2).
