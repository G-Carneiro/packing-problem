...
do problema.
Ela foi utilizada nos trabalhos de \citeauthor*{hopper2001empirical} na comparação de vários
métodos de solução, \citeauthor*{wei2011skyline} trazendo uma revisão do método e seus derivados
e, mais recentemente, \citeauthor*{chehrazad2022fast} através de uma adaptação para o empacotamento
