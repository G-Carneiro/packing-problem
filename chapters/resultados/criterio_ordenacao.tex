...
\input{utils/tables/compare/ordenacao}
...
nulo.
Por isso ele também se sai muito melhor que os demais na ordenação crescente, sendo o vitorioso
...
\input{utils/tables/compare/ordenacao_true}
