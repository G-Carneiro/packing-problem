...
A \Cref{fig:estado-inicial} representa o estado inicial do modelo, onde ainda não existem peças
alocadas.
% TODO: talvez separar as justificativas para qualidade e quantidade e falar sobre o tempo separado.

\input{utils/figures/ordenacao/estado_0}
...
\input{utils/figures/ordenacao/estado_1}
...
\input{utils/figures/ordenacao/estado_2}

A \Cref{fig:estado-final} mostra o estado final do modelo e grande parte do espaço ainda está livre.
Na \Cref{tab:bkw01} do \Cref{ch:tabelas} é possível ver que a qualidade de solução do modelo com
...
\input{utils/figures/ordenacao/estado_final}
