...
\begin{document}
    \begin{frame}[plain]
        ...
        \note{
            ...
            O trabalho trata sobre a avaliação demétodos de solução baseados em \textit{bottom-left}
            para problema de empacotamento.
    ...
    \begin{frame}
        ...
        \note{
            Vou comçar explicando o problema em si, passando por suas características e classificações.

            Vou mostrar o que é \textit{bottom-left}, como ela funciona e os métodos feitos
            com base nela.
