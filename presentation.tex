...
\begin{document}
    ...
    \begin{frame}
        ...
        \note{\scriptsize Bom, indo para as conclusões. Foram testados vários métodos de solução,
            todos baseados em \textit{bottom-left}, ficou evidente que ordenar a lista de entrada de
            ...
            a pouca, ou nenhuma, vantagem em termos de qualidade quando usamos regiões que
            ...
            Por fim, caso se queira aumentar a escala dos problemas, seja na dimensão ou na quantidade
            de itens, compensa somente trabalhar com regiões sem sobreposição. No caso de aumentar
            a dimensão seu custo é baixo, sendo necessário verificar somente um parâmetro extra.}
    \end{frame}
