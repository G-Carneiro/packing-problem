...
\begin{document}
    \begin{frame}[plain]
        ...
        \note{
            ...
            O trabalho trata sobre a avaliação de métodos de solução baseados em
    ...
    \begin{frame}
        ...
        \note{
            Eu vou começar explicando o problema em si, passando por suas características e
            abordando a versão de estudo do trabalho.
            ...
            E, por fim, vou apresentar algumas conclusões que podem ser feitas a partir do trabalho.
        }
    \end{frame}
    ...
    \begin{frame}[allowframebreaks, noframenumbering]
        ...
        \framesubtitle{}
        \printbibliography\nocite{cavali2004problemas,belluzzo2005otimizacao}
        \note{Bom, era isso o que tinha para apresentar, obrigado pela atenção.}
    \end{frame}
    \input{beamer/extras}
\end{document}